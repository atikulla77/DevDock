...
const Footer1 = () => {
  ...
  const innerValue = `
  <footer className="text-gray-600 h-[100%] bg-white body-font">
  <div className="container px-5 py-24 mx-auto bg-white flex bg-white md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
